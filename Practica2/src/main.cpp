...
const char *daysOfTheWeek[] = {"Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"};
const char *monthNames[] = {"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio",
...
String formatDateTime(String datetime) // 2023-03-09T10:16:43.457711-05:00
{
  ...
  String nameOfDay = daysOfTheWeek[dayOfWeek - 1]; // obtiene el nombre del día de la semana
  String monthName = String(monthNames[tm.Month - 1]);
